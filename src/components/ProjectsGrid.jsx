              ...
              <React.Fragment key={`projects-row-${row_key}`}>
                {row.map((item, key) => (
                  <div className={renderProjectColumnClass(row_key, key, "column")} key={`projects-item-${key}`}>
                    ...
                    <Link href={`/projects/${item.id}`} className={renderProjectColumnClass(row_key, key, "item")}
                          data-value-1="-30" data-value-2="0">
                      <div className="mil-cover-frame mil-hori mil-up">
                        <div className={renderProjectColumnClass(row_key, key, "image")} data-value-1="1.2"
                             data-value-2="1">

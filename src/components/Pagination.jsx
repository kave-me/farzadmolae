  ...
  return (
    <div className="col-lg-12">
      ...
      <div className="mil-pagination">
        {currentPage > 1 &&
          <Link key="pagination-item-prev"
                href={currentPage > 1 ? renderPageLink(currentPage - 1) : renderPageLink(currentPage)}
                className="mil-pagination-btn mil-pagination-btm--prev">&laquo;</Link>
        }
        ...
        {currentPage < pages.length &&
          <Link key="pagination-item-next"
                href={currentPage < pages.length ? renderPageLink(currentPage + 1) : renderPageLink(currentPage)}
                className="mil-pagination-btn mil-pagination-btn--next">&raquo;</Link>
        }
      </div>
      {/* pagination end */}

    ...
    <>
      ...
      <section className="mil-banner-personal">
        ...
        <div className="mil-animation-frame">
          <div className="mil-animation mil-position-4 mil-dark mil-scale" data-value-1="7" data-value-2="1.4"
               style={{ "right": "25%" }}>
            <Pentagon />
          </div>
        </div>
                ...
                <div className="mil-social-frame">
                  <ul className="mil-social-icons mil-dark">
                    {Data.bottom.social.map((social, key2) => (
                      <li key={`hero2-social-${key2}`}><a href={social.link} target="_blank" className="social-icon"
                                                          title={social.title}> <i className={social.icon} /></a></li>
                    ))}
                  </ul>
                </div>

          ...
          <div className="row justify-content-between align-items-center  ">
            <div className="col-lg-6 col-xl-5">
              ...
              <div className="mil-mb-90  ">
                <h2 className="mil-up mil-mb-60 fa-fix " dangerouslySetInnerHTML={{ __html: Data.title }} />
                <div className="mil-text mil-up mil-mb-30 about-landing "
            ...
            <div className="col-lg-5">
              ...
              <div className="mil-about-photo mil-mb-90">
                ...
                <div className="mil-up mil-img-frame" style={{ "paddingBottom": "160%" }}>
                  <img src={Data.image.url} alt={Data.image.alt} className="mil-scale" data-value-1="1"
                       data-value-2="1.2" />
                </div>
              </div>

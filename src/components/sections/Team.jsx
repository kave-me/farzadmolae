          ...
          <div className="row justify-content-between align-items-center">
            <div className="col-lg-5 col-xl-4">
              ...
              <div className="mil-mb-90">
                ...
                <div className="mil-up"><Link href={Data.button.link}
                                              className="mil-button mil-arrow-place mil-mb-60"><span>{Data.button.label}</span><ArrowIcon /></Link>
                </div>
                          ...
                          <div className="mil-secrc-text">
                            ...
                            <ul className="mil-social-icons mil-center">
                              {item.social.map((social, key2) => (
                                <li key={`services1-item${key}-social-${key2}`}><a href={social.link} target="_blank"
                                                                                   className="social-icon"
                                                                                   title={social.title}> <i
                                  className={social.icon} /></a></li>
                              ))}
                            </ul>
                          </div>
                        </div>
                      ...
                      <div key={`services2-item-${key}`} className="mil-team-card mil-up mil-mb-30">
                        ...
                        <div className="mil-description">
                          <div className="mil-secrc-text">
                            ...
                            <ul className="mil-social-icons mil-center">
                              {item.social.map((social, key2) => (
                                <li key={`services2-item${key}-social-${key2}`}><a href={social.link} target="_blank"
                                                                                   className="social-icon"
                                                                                   title={social.title}> <i
                                  className={social.icon} /></a></li>
                              ))}
